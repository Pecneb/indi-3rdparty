...
static std::unique_ptr<Mount> simpleScope(new Mount());
...
***************************************************************************************/
bool Mount::Handshake()
{
    // When communicating with a real mount, we check here if commands are receieved
    // and acknolowedged by the mount. For Mount, we simply return true.
    return true;
}
...
***************************************************************************************/
const char *Mount::getDefaultName()
{
    return "ArduinoGOTO";
}
...
***************************************************************************************/
bool Mount::Goto(double ra, double dec)
{
    targetRA  = ra;
    targetDEC = dec;
